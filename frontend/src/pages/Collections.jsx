...
function Collections() {
  ...
  return (
    <div className="w-full min-h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-start flex-col md:flex-row justify-start pt-[70px] overflow-x-hidden z-[2] pb-[110px]">
      <div
      ...
      <div className="lg:pl-[20%] md:py-[10px]">
        <div className="md:w-full w-full p-[20px] flex justify-between flex-col lg:flex-row lg:px-[50px]">
        ...
        <div className="lg:w-[80vw] md:w-full w-full min-h-[70vh] flex items-center justify-center flex-wrap gap-[30px]">
