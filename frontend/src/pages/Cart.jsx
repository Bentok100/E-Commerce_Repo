...
function Cart() {
  ...
  return (
    <div className="w-full min-h-[100vh] p-[20px] overflow-hidden bg-gradient-to-l from-[#141414] to-[#0c2025]">
              ...
              <div className="w-full h-[80%] flex items-start gap-6 bg-[#51808048] py-[10px] px-[20px] rounded-2xl relative">
                ...
                <div className="flex items-start justify-center flex-col gap-[10px]">
                  ...
                  <div className="flex items-center gap-[20px]">
                    ...
                    <p className="w-[40px] h-[40px] text-[16px] text-white bg-[#518080b4] rounded-md mt-[5px] flex items-center justify-center border border-[#9ff9f9]">
                      {item.size}
                    </p>
                  </div>
                </div>
      ...
      <div className="flex justify-start items-end my-20">
        <div className="w-full sm:w-[450px]">
          <CartTotal />
          <button
            className="text-[18px] hover:bg-slate-500 cursor-pointer bg-[#51808048] py-[10px] px-[50px] rounded-2xl text-white flex items-center justify-center gap-[20px] border border-[#80808049] mt-[20px]"
            onClick={() => {
